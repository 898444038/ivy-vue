<template>
  <div id="simple-calendar-app">
        ...
        <div slot="header" class="mb-4">
          <div class="vx-row no-gutter">
            ...
            <div class="vx-col w-1/3 items-center sm:flex hidden">
              ...
              <vs-button v-show="$acl.check('admin')" icon-pack="feather" icon="icon-plus" @click="promptAddNewEvent(new Date())">新增活动</vs-button>
            </div>
            <!-- Current Month -->
    ...
    <vs-prompt
        ...
        <vs-textarea name="event-name" height="160px" v-validate="'required'" class="w-full" label-placeholder="Event Title" v-model="title"></vs-textarea>
        <div class="my-4">
    ...
    <vs-prompt
        ...
        <vs-textarea name="event-name" disabled height="160px" v-validate="'required'" class="w-full" label-placeholder="Event Title" v-model="title"></vs-textarea>
        <!-- <div class="my-4">
            <small class="date-label">Start Date</small>
...
export default {
  ...
  computed: {
    ...
    calendarLabels () {
      ...
      return [
        { text: '充值', value: '充值', color: 'success' },
        { text: '消费', value: '消费', color: 'warning' },
        { text: '招募', value: '招募', color: 'danger' }
      ]
    },
    labelColor () {
      return (label) => {
        if      (label === '充值') return 'success'
        else if (label === '消费')     return 'warning'
        else if (label === '招募') return 'danger'
        else if (label === 'other')     return 'primary'
      }
    },
    windowWidth () {

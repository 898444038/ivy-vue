...
import navMenuItemsEditor  from '@/layouts/components/vertical-nav-menu/navMenuItemsEditor.js'
...
export default {
  ...
  data () {
    ...
    return {
      ...
      dynamicWatchers   : {},
      footerType        : themeConfig.footerType  || 'sticky',
      hideScrollToTop   : themeConfig.hideScrollToTop,
      isNavbarDark      : false,
      navbarColor       : themeConfig.navbarColor || '#fff',
      navbarType        : themeConfig.navbarType  || 'floating',
      navMenuItems      : 'admin' === userRole ? navMenuItems : navMenuItemsEditor,

<template>
  <div
    ...
    @mouseleave  = "mouseout">
      ...
      <ul :style="styleItems" class="h-nav-group-items h-nav-menu-dd nm-2 absolute shadow-drop py-2" v-show="openItems" ref="childDropdown">
...
export default {
  ...
  methods: {
    ...
    showChildren (val = true) {
      ...
      const submenuList = this.group.submenu
      let flag = false //有无权限

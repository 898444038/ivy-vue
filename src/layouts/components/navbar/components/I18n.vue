<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      <vs-dropdown-item @click="updateLocale('cn')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/cn.png" alt="cn" />Chinese</vs-dropdown-item>
...
export default {
  computed: {
    i18n_locale_img () {
      ...
      if (locale === 'cn')      return require('@/assets/images/flags/cn.png')
    ...
    getCurrentLocaleData () {
      const locale = this.$i18n.locale
      if (locale === 'cn')      return { flag: 'cn', lang: 'Chinese'    }
